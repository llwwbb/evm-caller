  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      ...
      <div className="flex flex-wrap items-center gap-3 border-b border-line bg-bg px-5 py-2.5 font-mono text-[13px]">
        ...
        <span className="text-[12px] uppercase tracking-[0.2em] text-fg-mute">op</span>
        <div className="flex gap-0.5">
          <ModeBtn
        ...
        <span className="text-line">/</span>
        <span className="text-[12px] uppercase tracking-[0.2em] text-fg-mute">preset</span>
        <select
        ...
        <button
          ...
          className="rounded-sm border border-line px-2 py-0.5 text-[12px] text-fg-dim hover:bg-surface-2"
        >
        ...
        <div className="ml-auto">
          <button
            ...
            className="rounded-sm bg-mint px-4 py-1 font-mono text-[13px] font-semibold text-bg"
          >
      ...
      {savingPreset && (
        <div className="flex items-center gap-2 border-b border-line bg-surface px-5 py-2">
          <input
            ...
            className="flex-1 rounded-sm border border-line bg-bg px-2 py-1 font-ui text-[14px] text-fg placeholder:text-fg-mute focus:border-mint focus:outline-none"
          />
          <button
      ...
      >
        ...
        <div className="flex min-h-0 flex-col border-r border-line">
          ...
          <div className="flex-1 overflow-y-auto p-4 font-mono text-[13px]">
            {typeEntries.map((entry, idx) => (
              ...
              >
                <span className="w-6 pt-1.5 text-[12px] text-fg-mute">[{idx}]</span>
                ...
                <div className="flex flex-col gap-0.5 pt-0.5">
                  <button
                    ...
                    disabled={idx === 0}
                    className="rounded-xs px-1 text-[12px] text-fg-mute hover:bg-surface-2 disabled:opacity-30"
                  >
                    ↑
                  </button>
                  <button
            ...
            {operationType === 'decode' && (
              <div className="mt-3">
                ...
                <textarea
                  ...
                  placeholder="0x..."
                  rows={6}
                  className="w-full resize-none rounded-sm border border-line bg-bg px-2 py-1.5 font-mono text-[13px] text-fg placeholder:text-fg-mute focus:border-mint focus:outline-none"
                />
                <label className="mt-2 flex items-center gap-2 text-[12px] text-fg-dim">
                  <input
                    type="checkbox"
                    checked={outputAsHex}
        ...
        <div className="flex min-h-0 flex-col overflow-y-auto">
          ...
          <div className="border-b border-line bg-surface px-5 py-4">
            ...
            {result ? (
              <pre className="whitespace-pre-wrap break-all rounded-sm border border-line-soft bg-bg px-2.5 py-2 font-mono text-[13px] text-fg">
                {result}
              </pre>
            ) : (
              <div className="font-ui text-[14px] text-fg-mute">
                  ...
                  <div key={h.id} className="border-b border-line-soft">
                    ...
                    {!isCollapsed && (
                      <div className="bg-surface-2 px-5 py-3 font-mono text-[12px] leading-[1.55]">
                        ...
                        <pre
                          className={
                            'whitespace-pre-wrap break-all rounded-sm border px-2.5 py-2 text-[12px] ' +
                            (h.success
