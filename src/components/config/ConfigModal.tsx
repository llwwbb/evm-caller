    ...
    >
      ...
      >
        <div className="flex items-center border-b border-line px-5 py-3">
          <h2 className="font-mono text-[13px] uppercase tracking-[0.22em] text-fg-dim">
        ...
        <div className="space-y-5 p-5 font-ui text-[14px] text-fg-dim">
          {/* Export */}
          <div>
            <div className="mb-1.5 font-mono text-[11px] uppercase tracking-[0.22em] text-fg-mute">
              {t('configManager.exportTitle')}
            </div>
            <p className="mb-2 text-[13px] text-fg-mute">
              {t('configManager.exportDescription')}
            </p>
            <button
              onClick={handleExport}
              className="rounded-sm border border-line px-3 py-1.5 font-mono text-[13px] text-fg hover:bg-surface-2"
            >
          ...
          {importResult && (
            <div
              className={
                'rounded-sm border px-3 py-2 font-mono text-[13px] ' +
